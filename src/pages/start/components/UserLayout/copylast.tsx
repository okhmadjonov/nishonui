...
// //     displayText,
// //     handleStart,
// //     handleFinish,   // handleFinish now does the finalize
// //     handleRestart,
// //     handleShoot,
// //     setMaxShots,
// //     setUserName,
...
// //   const [shotsState, setShotsState] = useState<
...
// //   // Finish from parent: stop interval and call handleFinish() (which finalizes once)
// //   useEffect(() => {
// //     if (finishSignal > 0) {
...
// //       }
// //       finishRef.current(); // <-- only this, no separate finalize
// //     }
// //   }, [finishSignal]);
...
// //     const theta =
// //       half === "upper" ? Math.random() * Math.PI
// //       : half === "lower" ? Math.PI + Math.random() * Math.PI
...
// //       if (timerIdRef.current) { clearInterval(timerIdRef.current); timerIdRef.current = null; }
// //       finishRef.current(); // <-- single path: finish handles finalize
// //       return;
// //     }
...
// //     if (firedRef.current >= maxShotsRef.current) {
// //       if (timerIdRef.current) { clearInterval(timerIdRef.current); timerIdRef.current = null; }
// //       finishRef.current(); // <-- finish (finalize inside)
// //     }
// //   };
...
// //   const safePhoto =
// //     user.photoUrl && user.photoUrl.trim() !== "" ? user.photoUrl : (defaultUser as string);
